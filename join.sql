...
/* При правом объединении таблиц customers и sales natural right join salespeople получаем список
всех покупателей из таблицы customers и null-значения там,
где покупателям не назначен продавец*/
